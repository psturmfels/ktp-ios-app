...
- (void)reloadPledgeTasks {
    [KTPNetworking sendAsynchronousRequestType:KTPRequestTypeGET toRoute:KTPRequestRouteAPIPledgeTasks appending:nil parameters:nil withBody:nil block:^(NSURLResponse *response, NSData *data, NSError *error) {
        if (error) {
